...
static uint8_t array_default_values [EEPROM_BYTES_STORED] = {
  ...
  DEFAULT_VALUE_MAIN_SCREEN_POWER_MENU_ENABLED                        // 103 + EEPROM_BASE_ADDRESS (Array index)
};
...
static void variables_to_array (uint8_t *ui8_array)
{
  ...
  ui8_array [103] = p_configuration_variables->ui8_main_screen_power_menu_enabled;
}
